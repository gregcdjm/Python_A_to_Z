...
def create_or_check_if_user_is_alive():
    ...
    while(i > 0):
        ...
        # On demande le pseudo d'un combattant.
            player1 = input("Entrer le nom d'un combattant ")
...
def combat():
        ...
        while(1):
            ...
            if index_player1 == index_player2: # <--- Vérification que les combattants sont différents.
                print("Le combatant {} est déjà  enregistré, recommencer "
                      .format(SuperPlayer.get_pseudo(list_players[index_player1])))
            else:
                break
    else:
    ...
    while(1):
        ...
        if SuperPlayer.get_health(list_players[index_player2]) <= 0:
            ...
            print(SuperPlayer.get_pseudo(list_players[index_player1])+" win, pv restant :"
               , SuperPlayer.get_health(list_players[index_player1]))
...
def new_player():
    ...
    while(1):
        ...
        if newplayer == "oui":
            ...
            newplayer_health = int(input("Entrez son nombre de point de vie : "))
            newplayer_attack = int(input("Entrez son nombre de point d'attaque : "))
    # Une fois toutes les informations propres au joueur collectées, nous créons le joueur grâce 
    # à la classe SuperPlayer.
    ...
    # Nous créons ici une liste qui gardera en mémoire les références des différents objets enregistrés.
            list_players.append(SuperPlayer(newplayer_name, newplayer_health, newplayer_attack))
